...
import 'package:vs/screens/CategorieCard/ou_aller_card/Composant/ou_aller_body.dart';
import 'package:vs/screens/Home/Hoome.dart';
import 'package:vs/screens/Home/bottom_bar.dart';

class oualler extends StatelessWidget {
  const oualler({super.key});

  @override
      static String routeName = "/oualler";
